    ...
    DATA_STR = <<JSON
{
  ...
  "composition": [
    ...
    { "section": {"type": "sections", "id": "info-1-type"}},
    { "section": {"type": "sections", "id": "info-2-what-is"}},
    { "section": {"type": "sections", "id": "info-3-latest"}},
